...
:root{--db-primary:#3B4FE4;--db-font:'Inter',sans-serif;}
.page-body,.page-wrapper{font-family:var(--db-font);background:#F5F6FA!important;}

/* Page header */
.db-page-header{background:linear-gradient(135deg,#3B4FE4 0%,#5B6CF9 100%);border-radius:10px;padding:22px 28px;margin-bottom:16px;position:relative;overflow:hidden;}
...
.db-kpi-card:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(59,79,228,0.1);}
...
.db-kpi-icon-blue{background:rgba(59,79,228,0.12);color:#3B4FE4;}
...
.db-badge-blue{background:rgba(59,79,228,0.1);color:#3B4FE4;}
...
.db-activity-amount{font-weight:700;font-size:0.88rem;color:#3B4FE4;}
...
.db-company-avatar{width:32px;height:32px;border-radius:8px;background:linear-gradient(135deg,#3B4FE4,#5B6CF9);color:#fff;display:inline-flex;align-items:center;justify-content:center;font-weight:700;font-size:0.8rem;flex-shrink:0;}
