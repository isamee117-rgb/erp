...
<div class="card inv-header-card">
  <div class="card-body inv-header-body">
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <button class="btn btn-light shadow-sm" data-bs-toggle="modal" data-bs-target="#newSReturnModal" class="btn-erp-sm">
  ...
  <div class="card-body inv-filter-body">
    <div class="row g-2 align-items-center">
      ...
      <div class="col-6 col-md-3">
        ...
        <input type="date" class="form-control inv-input" id="dateFrom">
      </div>
      <div class="col-6 col-md-3">
        <label class="pm-label">To</label>
        <input type="date" class="form-control inv-input" id="dateTo">
      </div>
      ...
      <div class="modal-body pm-modal-body">
        <div class="pm-field-row">
          ...
          <div class="sdd-wrap" id="saleSelect-sdd">
            <div class="sdd-trigger sr-sdd-trigger" id="saleSelect-trigger" onclick="sddToggle('saleSelect-sdd')">
              <span class="sdd-disp" id="saleSelect-disp" class="erp-dropdown-placeholder">-- Select an Invoice --</span>
          ...
          <div class="pm-field-row">
            ...
            <div class="table-responsive">
              <table class="table table-sm inv-table mb-0">
                <thead><tr><th class="inv-th">Product</th><th class="inv-th">Sold Qty</th><th class="inv-th">Return Qty</th><th class="inv-th">Price</th></tr></thead>
...
.pm-input{height:38px!important;border-radius:7px!important;border:1px solid #DDE1EC!important;background:#FFFFFF!important;font-size:0.875rem!important;font-weight:500!important;color:#1A1D2E!important;}
...
.pm-btn-cancel{background:none;border:none;color:#6B7280;font-size:0.875rem;font-weight:500;padding:9px 16px;cursor:pointer;}
.pm-btn-save{background:linear-gradient(135deg,#3B4FE4,#5B6CF9);border:none;border-radius:7px;padding:9px 22px;font-size:0.875rem;font-weight:600;color:#fff;cursor:pointer;display:inline-flex;align-items:center;}

/* ── Modal overflow fix so SDD panel isn't clipped ── */
#newSReturnModal .pm-modal-content { overflow: visible !important; }
#newSReturnModal .pm-modal-header  { border-radius: 12px 12px 0 0; overflow: hidden; }
...
.sdd-wrap.open .sr-sdd-trigger { border-color: #5B6CF9; box-shadow: 0 0 0 3px rgba(91,108,249,0.12); }
